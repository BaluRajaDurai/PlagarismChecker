                ...
                <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                    <ul class="navbar-nav">
                        <li class="nav-item ps-4">
                            <Link to="/topics" className="text-decoration-none text-uppercase btn btn-primary">Topics</Link>
                        </li>
                        <li class="nav-item ps-4">
                            <Link to="/comments" className="text-decoration-none text-uppercase btn btn-primary">Comments</Link>
                        </li>
                    </ul>
                    <form class="d-flex">
                    <button 
