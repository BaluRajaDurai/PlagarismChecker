                ...
                <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                    <ul class="navbar-nav">
                        <li class="nav-item ps-4">
                            <Link to="/uploadtopic" className="text-decoration-none text-uppercase btn btn-primary">Upload Topic</Link>
                        </li>
                        <li class="nav-item ps-4">
                            <Link to="/submisson" className="text-decoration-none text-uppercase btn btn-primary">Submisson</Link>
                        </li>
                    </ul>
                    <form class="d-flex">
                    <button 
